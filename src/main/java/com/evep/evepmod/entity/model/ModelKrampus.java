 ...
 */
public class ModelKrampus extends ModelBase {
    ...
    public ModelKrampus() {
        ...
        this.LeftHorn = new ModelRenderer(this, 50, 4);
        this.LeftHorn.setRotationPoint(4.0F, -5.0F, 0.0F);
        this.LeftHorn.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.setRotateAngle(LeftHorn, 0.0F, 0.0F, -2.356194490192345F);
        this.RightLeg = new ModelRenderer(this, 0, 16);
        this.RightLeg.setRotationPoint(-1.9F, 11.5F, 0.1F);
        this.RightLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
        this.setRotateAngle(RightLeg, 0.2617993877991494F, 0.0F, 0.0F);
        this.LeftLeg = new ModelRenderer(this, 0, 16);
        this.LeftLeg.mirror = true;
        this.LeftLeg.setRotationPoint(1.9F, 11.5F, 0.1F);
        ...
        this.RightHorn = new ModelRenderer(this, 50, 4);
        this.RightHorn.setRotationPoint(-3.3F, -5.8F, 0.0F);
        this.RightHorn.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.setRotateAngle(RightHorn, 0.0F, 0.0F, 2.356194490192345F);
