...
import com.evep.evepmod.entity.model.ModelMinotaur;
...
{
	public static final ResourceLocation TEXTURES = new ResourceLocation(VanillaEvolutionMod.MODID + ":textures/entity/minotaur.png");
