...
public class ItemSelenitePickaxe extends ItemPickaxe{
	
	public ItemSelenitePickaxe(String name, ToolMaterial material, float damage, float speed) {
		super(material);
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.selenite;
	}
