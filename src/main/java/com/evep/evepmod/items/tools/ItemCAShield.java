...
public class ItemCAShield extends ItemSword{

	public ItemCAShield(String name, ToolMaterial material, float damage, float speed) {
		super(material);
