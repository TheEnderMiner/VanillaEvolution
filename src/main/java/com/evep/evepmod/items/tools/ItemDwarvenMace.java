...
public class ItemDwarvenMace extends ItemSword{

	public ItemDwarvenMace(String name, ToolMaterial material) {
		super(material);
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
	     ...
	     tooltip.add("Large enough to crush the skulls of your enemies");
	}
