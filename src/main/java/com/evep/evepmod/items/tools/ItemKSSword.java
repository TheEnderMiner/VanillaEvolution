...
public class ItemKSSword extends ItemSword{

	public ItemKSSword(String name, ToolMaterial material, float damage, float speed) {
		super(material);
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
	     ...
	     tooltip.add("When crafted, it has Sweeping Edge V");
	}
	
	public void onCreated(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
	par1ItemStack.addEnchantment(Enchantment.getEnchantmentByID(22), 5);
	}
