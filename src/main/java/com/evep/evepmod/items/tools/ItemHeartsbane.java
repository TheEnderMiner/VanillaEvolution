...
public class ItemHeartsbane extends ItemSword{

	public ItemHeartsbane(String name, ToolMaterial material) {
		super(material);
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.valyrian_steel;
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
	     ...
	     tooltip.add("The sword of House Tarly");
	}
