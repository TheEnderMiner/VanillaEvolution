...
public class ItemLLocketArmor extends ItemArmor implements IHasModel{

	public ItemLLocketArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	{
		{
			...
			{
				{
					if(player.inventory.armorInventory.get(2).getItem() == VanillaEvolutionItems.leaping_locket)
					{
