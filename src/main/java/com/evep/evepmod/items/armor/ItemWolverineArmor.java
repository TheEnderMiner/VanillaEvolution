...
public class ItemWolverineArmor extends ItemArmor implements IHasModel{

	public ItemWolverineArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.adamantium_ingot;
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack item)
	{
		...
		{
			if(player.inventory.armorInventory.get(0).getItem() == VanillaEvolutionItems.wolverine_boots &&
				player.inventory.armorInventory.get(1).getItem() == VanillaEvolutionItems.wolverine_leggings && 
