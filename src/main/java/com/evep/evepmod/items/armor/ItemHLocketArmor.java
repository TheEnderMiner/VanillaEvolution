...
public class ItemHLocketArmor extends ItemArmor implements IHasModel{

	public ItemHLocketArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
