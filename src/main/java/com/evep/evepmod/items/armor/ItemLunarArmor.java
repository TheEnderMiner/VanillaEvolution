...
public class ItemLunarArmor extends ItemArmor implements IHasModel{

	public ItemLunarArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.moon_gem;
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack item)
	{
		...
		{
			if(player.inventory.armorInventory.get(0).getItem() == VanillaEvolutionItems.lunar_boots &&
				player.inventory.armorInventory.get(1).getItem() == VanillaEvolutionItems.lunar_leggings && 
