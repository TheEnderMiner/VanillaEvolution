...
public class ItemBLocketArmor extends ItemArmor implements IHasModel{

	public ItemBLocketArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
