...
public class ItemNightsWatchArmor extends ItemArmor implements IHasModel{

	public ItemNightsWatchArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(I18n.format("A Now Your Watch Begins"));
		tooltip.add(I18n.format("Full Set Bonus: Night Vision"));
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack item)
	{
		...
		{
			if(player.inventory.armorInventory.get(0).getItem() == VanillaEvolutionItems.nights_watch_boots &&
