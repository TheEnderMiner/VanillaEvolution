...
public class ItemCobaltArmor extends ItemArmor implements IHasModel{

	public ItemCobaltArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.cobalt_ingot;
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack item)
	{
		...
		{
			if(player.inventory.armorInventory.get(0).getItem() == VanillaEvolutionItems.cobalt_boots &&
				player.inventory.armorInventory.get(1).getItem() == VanillaEvolutionItems.cobalt_leggings && 
