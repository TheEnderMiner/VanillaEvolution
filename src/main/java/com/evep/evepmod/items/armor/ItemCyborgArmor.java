...
public class ItemCyborgArmor extends ItemArmor implements IHasModel{

	public ItemCyborgArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
