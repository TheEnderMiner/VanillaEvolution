...
public class ItemFFLocketArmor extends ItemArmor implements IHasModel{

	public ItemFFLocketArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	{
		{
			...
			{
				{
					if(player.inventory.armorInventory.get(2).getItem() == VanillaEvolutionItems.fast_fighting_locket)
					{
