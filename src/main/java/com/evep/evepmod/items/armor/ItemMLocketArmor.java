...
public class ItemMLocketArmor extends ItemArmor implements IHasModel{

	public ItemMLocketArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	{
		{
			...
			{
				{
					if(player.inventory.armorInventory.get(2).getItem() == VanillaEvolutionItems.mining_locket)
					{
