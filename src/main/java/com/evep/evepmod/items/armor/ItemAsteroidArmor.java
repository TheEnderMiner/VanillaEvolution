...
public class ItemAsteroidArmor extends ItemArmor implements IHasModel{

	public ItemAsteroidArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public boolean getIsRepairable(ItemStack armor, ItemStack stack){
		return stack.getItem() == VanillaEvolutionItems.asteroid_ingot;
	}
