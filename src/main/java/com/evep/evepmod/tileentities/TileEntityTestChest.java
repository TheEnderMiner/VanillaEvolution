...
//
//public class TileEntityTestChest extends TileEntityLockableLoot implements ITickable{
//	
...
//		return this.hasCustomName() ? this.customName : "container.test_chest";
//	}
//
//	@Override
...
//		if(compound.hasKey("CustomeName", 8)) compound.setString("CustomName", this.customName);
//		
//		return compound;
//	}
//	
...
//		return new ContainerTestChest(playerInventory, this, playerIn);
//	}
//	
//	@Override
//	public String getGuiID() { 
//		return VanillaEvolutionMod.MODID + ":test_chest"; 
//	}
//	
//	@Override
...
//            {
//                if (entityplayer.openContainer instanceof ContainerTestChest)
//                {
//                    if (((ContainerTestChest)entityplayer.openContainer).getChestInventory() == this)
//                    {
