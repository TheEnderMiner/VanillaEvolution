...
public class BiomeEvolvedArctic extends Biome{
	...
	public BiomeEvolvedArctic(){
		...
		this.spawnableMonsterList.add(new SpawnListEntry(EntityEvoker.class, 35, 1, 2));
		...
		this.spawnableMonsterList.add(new SpawnListEntry(EntitySpellcasterIllager.class, 25, 1, 1));
