...
public class ChunkGeneratorEarth implements IChunkGenerator
{
    ...
    //Main Block
    protected static final IBlockState MAIN_BLOCK = VanillaEvolutionBlocks.earthen_stone.getDefaultState();
    //Block that is usally Lava
    protected static final IBlockState YOUR_LIQUID = VanillaEvolutionBlocks.earthen_dirt.getDefaultState();
    //Blocks that are usally gravel and soul sand
    protected static final IBlockState OTHER_BLOCK1 = VanillaEvolutionBlocks.earthen_dirt.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = VanillaEvolutionBlocks.earthen_dirt.getDefaultState();
...
//    private final WorldGenStructure HOUSE = new WorldGenStructure("House");
    ...
    public ChunkGeneratorEarth(World world, boolean generate, long seed)
    {
        this.world = world;
