...
public class WorldGenDwarvenShrine implements IWorldGenerator{
	
//	public final WorldGenStructure ICE_TEMPLE = new WorldGenStructure("ice_temple");
	public final WorldGenStructureDwarvenShrine DWARVEN_SHRINE = new WorldGenStructureDwarvenShrine("dwarven_shrine");
