...
public class BlockWalnutCrop extends BlockCrops {
	...
	public BlockWalnutCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.walnut_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.walnut;
	}
