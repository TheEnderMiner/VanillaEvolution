...
public class BlockVanillaCrop extends BlockCrops {
	...
	public BlockVanillaCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.vanilla_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.vanilla;
	}
