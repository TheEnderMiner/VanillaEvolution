...
public class BlockRhubarbCrop extends BlockCrops {
	...
	public BlockRhubarbCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.rhubarb_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.rhubarb;
	}
