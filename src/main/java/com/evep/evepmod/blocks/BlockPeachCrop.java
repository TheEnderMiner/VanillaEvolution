...
public class BlockPeachCrop extends BlockCrops {
	...
	public BlockPeachCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.peach_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.peach;
	}
