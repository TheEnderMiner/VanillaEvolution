...
public class BlockPineappleCrop extends BlockCrops {
	...
	public BlockPineappleCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.pineapple_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.pineapple;
	}
