...
public class BlockCherryCrop extends BlockCrops {
	...
	public BlockCherryCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.cherry_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.cherry;
	}
