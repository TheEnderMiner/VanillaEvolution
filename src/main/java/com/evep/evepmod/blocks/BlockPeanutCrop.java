...
public class BlockPeanutCrop extends BlockCrops {
	...
	public BlockPeanutCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.peanut_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.peanut;
	}
