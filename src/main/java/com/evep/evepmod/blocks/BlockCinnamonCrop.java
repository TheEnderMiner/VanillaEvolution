...
public class BlockCinnamonCrop extends BlockCrops {
	...
	public BlockCinnamonCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.cinnamon_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.cinnamon;
	}
