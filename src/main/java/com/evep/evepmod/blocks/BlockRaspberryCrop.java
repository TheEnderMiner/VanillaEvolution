...
public class BlockRaspberryCrop extends BlockCrops {
	...
	public BlockRaspberryCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.raspberry_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.raspberry;
	}
