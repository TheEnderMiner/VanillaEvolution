...
public class BlockDwarfStarAlloyOre extends Block{
	
	public BlockDwarfStarAlloyOre(String name, Material material) {
		super(material);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune){
		return VanillaEvolutionItems.dwarf_star_alloy;
	}
	 @Override
