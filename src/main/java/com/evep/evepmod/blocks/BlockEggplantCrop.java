...
public class BlockEggplantCrop extends BlockCrops {
	...
	public BlockEggplantCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.eggplant_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.eggplant;
	}
