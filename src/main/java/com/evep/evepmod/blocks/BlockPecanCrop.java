...
public class BlockPecanCrop extends BlockCrops {
	...
	public BlockPecanCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.pecan_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.pecan;
	}
