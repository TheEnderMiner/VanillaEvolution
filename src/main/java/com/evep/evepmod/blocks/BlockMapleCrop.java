...
public class BlockMapleCrop extends BlockCrops {
	...
	public BlockMapleCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.maple_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.maple;
	}
