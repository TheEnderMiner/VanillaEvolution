...
public class BlockBlueberryCrop extends BlockCrops {
	...
	public BlockBlueberryCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.blueberry_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.blueberry;
	}
