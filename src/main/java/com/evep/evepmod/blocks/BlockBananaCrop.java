...
public class BlockBananaCrop extends BlockCrops {
	...
	public BlockBananaCrop(String name) {
		super();
	...
	{
		return VanillaEvolutionItems.banana_seed;
	}

	protected Item getCrop()
	{
		return VanillaEvolutionItems.banana;
	}
